...
The height of a banner is not set and can be adjusted to fit the design. However, each grid unit has a specific width. Because cropping is used, only a portion of the total image should contain information. For instance, a half-width unit image should be 1125px wide, but and text or important imagery should only fill 726px.
